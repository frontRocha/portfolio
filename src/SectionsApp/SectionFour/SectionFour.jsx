...
export default function SectionFour() {
    return(
        <section id="section4" className="bg-[#F0F0F0]">
            ...
            <div className="max-w-[1400px] mx-auto px-10">
                <div className="grid grid-cols-1 phone:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 place-items-center place-content-center gap-10">
                    {Skills.map((item, index) => (
                        <div className="bg-white px-10 shadow-xl flex flex-col items-center justify-center text-center rounded-2xl w-[150px] lg:w-[200px] my-2" key={index}>
